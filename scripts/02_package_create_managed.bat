...
SET packageName=Lightweight - Oxford Risk Auth Provider
SET packageDescription=A lightweight Auth Provider to connect to the Oxford Risk APIs using a Named Credential.
SET packageType=Managed
SET packagePath=force-app/package

REM Package Config
SET packageId=0HoP300000001QjKAI
SET packageVersionId=04tP3000001PmTtIAK
